...
const COREQS = {
  CEN: [
    ['EEN210',  'EEN210L'],   // EEN210L co-req with EEN210
    ['PHY102',  'PHY102L'],   // PHY102L co-req with PHY102 (MTT102 is prereq)
    ['PHY201',  'PHY201L'],   // PHY201L co-req with PHY201 (PHY102 is prereq)
    ['MTT204',  'MTT205'],    // MTT205 co-req with MTT204
    ['CEN464',  'CEN464L'],   // CEN464L co-req with CEN464
    ['CEN425',  'CEN401L'],   // CEN401L co-req with CEN425
    ['CSC202',  'CSC202L'],   // CSC202L co-req with CSC202
  ],
  CSE: [
    ['PHY102',  'PHY102L'],   // PHY102L co-req with PHY102
    ['PHY201',  'PHY201L'],   // PHY201L co-req with PHY201
    ['CHE205',  'CHE201L'],   // CHE201L co-req with CHE205
    ['CSC305',  'ITE408'],    // ITE408 co-req with CSC305
  ],
  SWE: [
    ['PHY102',  'PHY102L'],   // PHY102L co-req with PHY102
    ['PHY201',  'PHY201L'],   // PHY201L co-req with PHY201
